...
export const translations = {
  SQ: {
    ...
    bookingConfirmedDesc: 'Kontrolloni email-in tuaj për të përfunduar regjistrimin. Llogaria juaj do të aktivizohet nga administratori pas konfirmimit të pagesës.',
  ...
  MK: {
    ...
    bookingConfirmedDesc: 'Проверете го вашиот е-маил за да ја завршите регистрацијата. Вашата сметка ќе биде активирана од администраторот по потврдата на уплатата.',
  ...
  EN: {
    ...
    bookingConfirmedDesc: 'Check your email to complete registration. Your account will be activated by admin after payment confirmation.',
